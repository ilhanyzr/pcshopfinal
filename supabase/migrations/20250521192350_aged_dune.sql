...
DELETE FROM products WHERE name = 'ASUS ROG G700TF Ultra';
...
INSERT INTO products (
  ...
  jsonb_build_object(
    'cpu', jsonb_build_object(
      ...
      'series', 'Intel Core Ultra Series',
      'family', 'Core Ultra 9',
      'manufacturer', 'Intel',
      'socket', 'LGA 1851',
      'base_clock', '3.8 GHz',
