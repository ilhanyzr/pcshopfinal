...
-- Then delete reviews that reference products
DELETE FROM reviews;

-- Now we can safely delete all products
DELETE FROM products;

-- Add new gaming PCs with verified images
...
(
  ...
  'https://images.unsplash.com/photo-1587831990711-23ca6441447b?auto=format&fit=crop&q=80&w=1920&h=1080',
  ARRAY[
...
(
  ...
  'https://images.unsplash.com/photo-1587831991559-20c1ba52a5df?auto=format&fit=crop&q=80&w=1920&h=1080',
  ARRAY[
